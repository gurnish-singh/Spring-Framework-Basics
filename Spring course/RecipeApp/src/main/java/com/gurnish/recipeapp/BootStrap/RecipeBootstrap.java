package com.gurnish.recipeapp.BootStrap;
...
import com.gurnish.recipeapp.model.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //get Categories
        Optional<Category> americanCategoryOptional = categoryRepository.findByDescription("Australian");
